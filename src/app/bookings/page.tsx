        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
              <div>
                <h1 className="text-xl sm:text-3xl font-bold text-white mb-2">My Bookings</h1>
                <p className="text-xs sm:text-sm text-gray-400">View and manage all your bookings</p>
              </div>
              <Link
                href="/book"
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="text-white font-medium capitalize">{booking.paymentStatus.toLowerCase()}</p>
                        </div>
                        <div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 lg:ml-4">
                      {booking.status === "PENDING" || booking.status === "CONFIRMED" ? (
                        <button
                          ...
                          className="px-4 py-2 bg-red-500/20 border border-red-500/30 text-red-400 rounded-lg text-sm font-medium hover:bg-red-500/30 transition-all flex items-center justify-center"
                        >
